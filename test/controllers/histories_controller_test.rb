...
class HistoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create history" do
    assert_difference('History.count') do
      post histories_url, params: { history: { event: @history.event, livestock_id: @history.livestock_id } }
    end
  ...
  test "should update history" do
    patch history_url(@history), params: { history: { event: @history.event, livestock_id: @history.livestock_id } }
